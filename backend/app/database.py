...
class Database:
    ...
    def _seed_data(self):
        # Create sample businesses for demo - Colombia
        sample_businesses = [
            {
                "id": str(uuid.uuid4()),
                "name": "Yoga Bogotá Studio",
                "description": "Estudio de yoga con clases de Hatha, Vinyasa, Yin y meditación guiada en el corazón de la Zona G.",
                "category": BusinessCategory.YOGA,
                "address": "Calle 69 #5-20",
                "city": "Bogotá",
                "country": "Colombia",
                "phone": "+57 601 345 6789",
                "email": "namaste@yogabogota.co",
            ...
            {
                "id": str(uuid.uuid4()),
                "name": "Pilates Studio Medellín",
                "description": "Estudio de Pilates con reformer, mat y clases personalizadas en El Poblado.",
                "category": BusinessCategory.PILATES,
                "address": "Cra 43A #1-50",
                "city": "Medellín",
                "country": "Colombia",
                "phone": "+57 604 890 1234",
                "email": "info@pilatesmed.co",
            ...
            },
            {
                ...
                "address": "Calle 116 #15-28",
                "city": "Bogotá",
                "country": "Colombia",
                "phone": "+57 601 789 0123",
                "email": "info@irongym.co",
            ...
            },
            {
                ...
                "email": "citas@barberiaclasica.co",
            ...
            {
                "id": str(uuid.uuid4()),
                "name": "Spa Serena Usaquén",
                "description": "Spa de lujo con masajes, tratamientos faciales, sauna y jacuzzi en el exclusivo sector de Usaquén.",
                "category": BusinessCategory.SPA,
                "address": "Cra 6 #119-24",
                "city": "Bogotá",
                "country": "Colombia",
                "phone": "+57 601 456 7890",
                "email": "reservas@spaserena.co",
